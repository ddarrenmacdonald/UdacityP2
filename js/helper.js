...
var HTMLheaderRole = '<span class="jobRole">%data%</span><hr/>';
...
var HTMLworkEmployer = '<a href="#" class="styleName">%data%';
...
var HTMLprojectTitle = '<a href="#" class="styleName">%data%</a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p><br>%data%</p>';
var HTMLprojectImage = '<img src="%data%">';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<a href="#" class="styleName">%data%';
...
var HTMLonlineTitle = '<a href="#" class="styleName">%data%';
